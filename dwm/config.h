...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	 [SchemeNorm] = { s_base00, s_base3, s_blue },
	 [SchemeSel]  = { s_base00, s_base2,  s_cyan  }, 
	 [SchemeStatus]  = { s_base00, s_base3,  "#000000"  }, // Statusbar right {text,background}
	[SchemeTagsSel]  = { s_base3, s_orange,  "#000000"  }, // Tagbar left selected {text,background}
	[SchemeTagsNorm]  = { s_base00, s_base3,  "#000000"  }, // Tagbar left unselected {text,background}
	[SchemeInfoSel]  = { s_base00, s_base2,  "#000000"  }, // infobar middle  selected
	[SchemeInfoNorm]  = { s_base00, s_base3,  "#000000"  }, // infobar middle  unselected				
	/* { s_base00, s_base3, s_base1 },      SchemeNorm light */
	/* { s_base00, s_base2, s_base1},       SchemeSel light */
};
