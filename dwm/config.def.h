...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	 [SchemeNorm] = { s_base00, s_base3, s_base1 },
	 [SchemeSel]  = { s_base00, s_base2,  s_base1  }, 
	 [SchemeStatus]  = { col_gray3, col_gray1,  "#000000"  }, // Statusbar right {text,background}
	[SchemeTagsSel]  = { col_gray4, col_cyan,  "#000000"  }, // Tagbar left selected {text,background}
	[SchemeTagsNorm]  = { col_gray3, col_gray1,  "#000000"  }, // Tagbar left unselected {text,background}
