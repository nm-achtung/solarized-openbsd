...
iconinit(void)
{
	...
	if(tagcols[BACK] == nil) {
		...
		/* Solarized Dark Top*/
		tagcols[BACK] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x002b36FF);
		tagcols[HIGH] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x2aa198FF);
		tagcols[BORD] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x657b83FF);
		tagcols[TEXT] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x657b83FF);
		tagcols[HTEXT] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x657b83FF);
	
		/* Solarized Dark Main */
		textcols[BACK] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x002b36FF);
		textcols[HIGH] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x073642FF);
		textcols[BORD] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x073642FF);
		textcols[TEXT] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x657b83FF);
		textcols[HTEXT] = allocimage(display, Rect(0,0,1,1), RGBA32, 1, 0x657b83FF);
